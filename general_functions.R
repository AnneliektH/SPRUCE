...
collapse_other_phylum <- function(tax, top.tax) {
  tax <- mutate(tax, Phylum2 = as.factor(ifelse(as.character(Phylum) %in% top.tax$Phylum, as.character(Phylum), "other")))
}
